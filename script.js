...
const CreateCars = (() => {
    ...
    function produceCars() {
      makeCar("mercedes", "german", "images/german1.jpg", true);
      makeCar("BMW", "german", "images/german2.jpg", true);
      makeCar("mercedes", "german", "images/german3.jpg", true);
      makeCar("BMW", "german", "images/german3.jpg", true);
      makeCar("mercedes", "german", "images/german3.jpg", true);
      makeCar("mercedes", "american", "images/american1.jpg", false);
      makeCar("mercedes", "american", "images/american2.jpg", false);
      makeCar("mercedes", "american", "images/american3.jpg", false);
    }
    produceCars();
